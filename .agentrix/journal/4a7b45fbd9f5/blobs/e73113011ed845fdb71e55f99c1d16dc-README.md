...
**Settlemint** is a modern, auto‑reconciled expense‑sharing system with blockchain‑backed settlement proofs. Think "Splitwise on Steroids" — built for transparency, accuracy, and trust.

## 🚀 Features

*   **👥 Group Management**: Create groups and invite friends via email instantly.
*   **💰 Smart Reconciliation**: Automatically calculates "who owes whom" to minimize unnecessary transactions.
...
*   **⚡ Real-time Dashboard**: A responsive interface to track expenses and balances.
